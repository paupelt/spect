# This script is based on the total_duration_of_labeled_segments.praat script,
# but this one processes all TextGrid files in a given folder.
#
...
# Modified by Mikko Tirronen 24.6.2016, added a loop to go through multiple files.
...
form Calculate the total duration of intervals
	...
	sentence Label
	sentence directory /path/to/folder
endform

# Preparing info window
writeInfo: "Script for counting durations"
printline
printline
printline
...
for ifile to numberOfFiles
   ...
   Read from file... 'directory$'/'fileName$'
	...
	printline 'fileName$'
	printline The total duration of the intervals in tier number 'duration_tier' was calculated.
